...
Game::Game() {
	std::vector<int8_t> start_board = {
		
	BLACK* ROOK_NM, BLACK* KNIGHT, BLACK* BISHOP, BLACK* QUEEN, BLACK* KING_NM, BLACK* BISHOP, BLACK* KNIGHT, BLACK* ROOK_NM, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
	   BLACK* PAWN,   BLACK* PAWN,   BLACK* PAWN,  BLACK* PAWN,    BLACK* PAWN,   BLACK* PAWN,   BLACK* PAWN,    BLACK* PAWN, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
	          VOID,          VOID,          VOID,         VOID,           VOID,          VOID,          VOID,           VOID, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
		      VOID,          VOID,          VOID,         VOID,           VOID,          VOID,          VOID,           VOID, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
			  VOID,          VOID,          VOID,         VOID,           VOID,          VOID,          VOID,           VOID, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
		      VOID,          VOID,          VOID,         VOID,           VOID,          VOID,          VOID,           VOID, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
	   WHITE* PAWN,   WHITE* PAWN,   WHITE* PAWN,  WHITE* PAWN,    WHITE* PAWN,   WHITE* PAWN,   WHITE* PAWN,    WHITE* PAWN, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
	WHITE* ROOK_NM, WHITE* KNIGHT, WHITE* BISHOP, WHITE* QUEEN, WHITE* KING_NM, WHITE* BISHOP, WHITE* KNIGHT, WHITE* ROOK_NM, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE, OUTSIDE,
	...
	std::vector<Chessman> white = {
		{KING, 116 }, { QUEEN, 115 }, { ROOK, 112 }, { ROOK, 119 },
		{BISHOP, 114}, {BISHOP, 117}, {KNIGHT, 113}, {KNIGHT, 118},
		{PAWN, 96 }, {PAWN, 97}, {PAWN, 98}, {PAWN, 99},
		{PAWN, 100}, {PAWN, 101}, {PAWN, 102}, {PAWN, 103}
	};

	std::vector<Chessman> black = {
		{KING, 4}, {QUEEN, 3}, {ROOK, 0}, {ROOK, 7},
		{BISHOP, 2}, {BISHOP, 5}, {KNIGHT, 1}, {KNIGHT, 6},
		{PAWN, 16}, {PAWN, 17}, {PAWN, 18}, {PAWN, 19},
		{PAWN, 20}, {PAWN, 21}, {PAWN, 22}, {PAWN, 23}
	};
